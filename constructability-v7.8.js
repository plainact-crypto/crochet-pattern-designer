// v7.9 — strict deterministic crochet constructability proof for the fixed lace flower.
// Verifies exact stitch sequences, chain continuity, anchors, joins, round closure, edge mapping, and geometry.
(()=>{
  const VERSION='v7.9';
